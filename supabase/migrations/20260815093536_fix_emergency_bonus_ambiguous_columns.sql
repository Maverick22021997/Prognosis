...
begin
  ...
  update public.season_participants as sp
  ...
  select
    ...
    v_participant.season_id::bigint,
    v_participant.user_id::uuid,
    v_participant.balance_gp::bigint,
    v_participant.emergency_refill_used::boolean,
    v_bonus_amount::bigint;
